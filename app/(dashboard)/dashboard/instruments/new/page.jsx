...
//         </Link>
//         <div>
//           <h1 className="text-2xl font-semibold text-gray-900">Register New Instrument</h1>
//           <p className="text-sm text-gray-500">Add a new laboratory instrument</p>
//         </div>
//       </div>
...
//             <div>
//               <label className="block text-sm font-medium text-gray-700 mb-1">Instrument Name <span className="text-red-500">*</span></label>
//               <input
//                 {...register("name")}
...
//         {/* Submit Buttons */}
//         <div className="flex justify-between flex-col sm:flex-row gap-4 pt-4">          <Link
