...
//         params: { patient_id: patientId }, // Use parameter, not bluId directly
//       });
...
//         dateOfBirth: p.date_of_birth ? p.date_of_birth.split('T')[0] : "", // Format date for input
//         gender: p.sex || "",
...
//         city: p.city || "", // If city exists in response
//         state: p.state || "", // If state exists in response
//         postalCode: p.postal_code || "", // If postal_code exists in response
//         country: "India",

//         aadhaar: p.aadhar_card_num || "",
//         abhaId: p.abha_number || "",

//         emergencyName: p.emergency_contact_name || "", // Map from API if available
//         emergencyRelation: p.emergency_relation || "", // Map from API if available
//         emergencyPhone: formatPhoneNumber(p.emergency_country_code, p.emergency_phone_number), // Map from API if available

//         isVip: p.is_vip || false, // Map from API if available
//       });

//     } catch (error) {
//       console.error("Error fetching BluHealth patient data:", error);
//       // Optionally show error message to user
//       // toast.error("Failed to fetch patient data from BluHealth");
//     } finally {
...
//             <p className="text-sm text-gray-500">MRN will be auto-generated after registration</p>
//           </div>
//           <div>
//             <div>
//               <input
...
//                 className="w-full px-4 py-3 rounded-2xl border border-gray-200 focus:outline-none focus:ring-2 focus:ring-[#1b4dff] focus:border-transparent text-sm bg-white"
