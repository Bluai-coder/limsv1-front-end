...
export default function AdminTemplatesPage() {
    ...
    // Hooks
    const { data: templatesData, isLoading, refetch } = useAdminTemplates({ search, type: filterType });
    const { data: statsData } = useAdminTemplateStatistics();
    const deleteTemplate = useDeleteAdminTemplate();
    const setDefault = useSetDefaultAdminTemplate();
    const duplicateTemplate = useDuplicateAdminTemplate();
