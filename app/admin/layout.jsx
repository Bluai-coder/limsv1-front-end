...
import {
    ...
    Lock, LogOut, Menu, X, PanelLeftClose,
    TestTube,
    IndianRupee,
    Workflow,
    ChevronDown,
...
const menuItems = [
    {
        ...
        items: [
            ...
            // { name: "Users", module: "Users", href: "#", icon: UserCog },
            ...
            // { name: "Physicians", module: "Physicians", href: "#", icon: UserCog },
            // { name: "Audit Logs", module: "Audit Logs", href: "#", icon: BarChart3 },
            // { name: "Notifications", module: "Notifications", href: "#", icon: Bell },
        ]
    }
];

// Collapsed menu icons (shows only icons when sidebar collapsed)
const collapsedMenuIcons = [
    { name: "Dashboard", href: "/admin/dashboard", icon: LayoutDashboard },
    { name: "Tenants", href: "/admin/tenants", icon: TestTubes },
    // { name: "Users", href: "#", icon: UserCog },
    { name: "Test Catalog", href: "/admin/upload-test-catalogs", icon: IndianRupee },
    { name: "Templates", href: "/admin/templates", icon: FileText },
    // { name: "Settings", href: "#", icon: Settings },
    // { name: "Physicians", href: "#", icon: UserCog },
    // { name: "Audit Logs", href: "#", icon: BarChart3 },
...
export default function Layout({ children }) {
    ...
    return (
        <div className={`flex h-screen w-full overflow-hidden bg-gray-50 dark:bg-gray-900 ${darkMode ? 'dark' : ''}`}>
              ...
              <div className="px-4 py-3">
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-9 pr-4 py-2 text-sm bg-gray-100 dark:bg-gray-800 border-0 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                    onChange={(e) => {
