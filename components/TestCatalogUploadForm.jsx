...
//                                 Total Tests: <span className="font-semibold text-gray-700">{totalRecords}</span>
//                             </div>
...
//                                                 <div><span className="text-gray-500">Display Name:</span> <span className="font-medium">{test.display_name || '-'}</span></div>
//                                                 <div><span className="text-gray-500">Department:</span> <span className="font-medium">{test.department || '-'}</span></div>
//                                                 <div><span className="text-gray-500">Sub Department:</span> <span className="font-medium">{test.sub_department || '-'}</span></div>
//                                                 <div><span className="text-gray-500">Specimen Type:</span> <span className="font-medium">{test.specimen_type || '-'}</span></div>
//                                                 <div><span className="text-gray-500">Specimen Volume:</span> <span className="font-medium">{test.specimen_volume_ml || '-'} ml</span></div>
//                                                 <div><span className="text-gray-500">Container Type:</span> <span className="font-medium">{test.container_type || '-'}</span></div>
//                                                 <div><span className="text-gray-500">Method:</span> <span className="font-medium">{test.method || '-'}</span></div>
//                                                 <div><span className="text-gray-500">TAT Hours:</span> <span className="font-medium">{test.tat_hours || '-'}</span></div>
//                                                 <div><span className="text-gray-500">Result Type:</span> <span className="font-medium">{test.result_type || '-'}</span></div>
//                                                 <div><span className="text-gray-500">Price:</span> <span className="font-medium">₹{test.price || 0}</span></div>
//                                                 <div><span className="text-gray-500">Requires Fasting:</span> <span className="font-medium">{test.requires_fasting ? 'Yes' : 'No'}</span></div>
//                                                 <div><span className="text-gray-500">Sort Order:</span> <span className="font-medium">{test.sort_order || '-'}</span></div>
//                                             </div>
...
//                                                                     <th className="px-3 py-2 text-left">Ref Low</th>
//                                                                     <th className="px-3 py-2 text-left">Ref High</th>
//                                                                     <th className="px-3 py-2 text-left">Critical Low</th>
//                                                                     <th className="px-3 py-2 text-left">Critical High</th>
//                                                                 </tr>
//                                                             </thead>
//                                                             <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
//                                                                 {test.analytes.map((analyte, aIdx) => (
//                                                                     <tr key={aIdx} className="hover:bg-gray-50 dark:hover:bg-gray-800/50">
//                                                                         <td className="px-3 py-2 font-mono text-xs">{analyte.code}</td>
//                                                                         <td className="px-3 py-2">{analyte.name}</td>
//                                                                         <td className="px-3 py-2">{analyte.unit || '-'}</td>
//                                                                         <td className="px-3 py-2">{analyte.sequence}</td>
//                                                                         <td className="px-3 py-2">{analyte.ref_low ?? '-'}</td>
//                                                                         <td className="px-3 py-2">{analyte.ref_high ?? '-'}</td>
//                                                                         <td className="px-3 py-2">{analyte.critical_low ?? '-'}</td>
//                                                                         <td className="px-3 py-2">{analyte.critical_high ?? '-'}</td>
//                                                                     </tr>
//                                                                 ))}
//                                                             </tbody>
//                                                         </table>
...
//     // Use the hooks from your adminFileUpload
...
//     // Preview file using XLSX (client-side)
...
//                     "sub_department": "Routine",
//                     "specimen_type": "whole blood",
//                     "specimen_volume_ml": 2,
//                     "container_type": "EDTA",
...
//         if (status === 'completed') {
//             return (
//                 <span className="inline-flex items-center gap-1 px-2 py-1 text-xs rounded-full bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-300">
...
//         }
//         return (
//             <span className="inline-flex items-center gap-1 px-2 py-1 text-xs rounded-full bg-yellow-100 text-yellow-800 dark:bg-yellow-900/30 dark:text-yellow-300">
...
//                                     Bulk upload tests and analytes using Excel, CSV, or JSON file
//                                 </p>
//                             </div>
//                         </div>
//                     </div>
...
//                                                     {isDragActive
//                                                         ? 'Drop your file here'
//                                                         : 'Drag & drop your Excel/CSV/JSON file here'
//                                                     }
//                                                 </p>
...
//                                                     <span>✓ Max 50MB</span>
//                                                 </div>
//                                                 <div className="mt-3 text-xs text-gray-400 bg-gray-50 dark:bg-gray-800 p-2 rounded">
//                                                     <p className="font-medium">📌 For JSON data, use CSV with single column named 'json_data'</p>
//                                                     <p>Each row's json_data should contain a valid JSON object of a test</p>
//                                                 </div>
//                                             </>
//                                         ) : (
//                                             <>
...
//                                                 className="flex-1 px-4 py-2 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white rounded-lg font-medium transition flex items-center justify-center gap-2"
//                                             >
...
//                                                 <div key={idx} className="p-3 bg-red-50 dark:bg-red-900/10 rounded-lg text-sm">
...
//                                                     + {validationErrors.length - 10} more issues
//                                                 </p>
//                                             )}
//                                         </div>
//                                     </div>
...
//                                                     <td className="px-6 py-4 font-medium">{upload.file_name}</td>
//                                                     <td className="px-6 py-4">{upload.total_records}</td>
...
//                                     <h2 className="text-lg font-semibold text-gray-900 dark:text-white">Download Template</h2>
//                                 </div>
//                                 <div className="p-5">
//                                     <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">
//                                         Download our Excel/CSV template. Each row contains a JSON object in the 'json_data' column.
//                                     </p>
//                                     <button
...
//                                 </p>
//                                 <code className="block text-xs bg-gray-100 dark:bg-gray-800 p-2 rounded font-mono overflow-x-auto">
//                                     json_data<br />
//                                     {"{\"code\":\"CBC\",\"name\":\"Complete Blood Count\",...}"}<br />
//                                     {"{\"code\":\"KFT\",\"name\":\"Kidney Function Test\",...}"}
//                                 </code>
//                                 <p className="text-xs text-gray-500 mt-3">
//                                     Each cell in the 'json_data' column must contain a valid JSON object of a test with its analytes.
//                                 </p>
//                             </div>
...
//                                         <span>Use the template for correct format</span>
//                                     </li>
//                                     <li className="flex items-start gap-2">
//                                         <Check className="w-4 h-4 text-green-600 mt-0.5 flex-shrink-0" />
//                                         <span>Each row = one complete test with all analytes</span>
//                                     </li>
//                                     <li className="flex items-start gap-2">
//                                         <Check className="w-4 h-4 text-green-600 mt-0.5 flex-shrink-0" />
//                                         <span>'json_data' column contains the entire test JSON</span>
//                                     </li>
//                                     <li className="flex items-start gap-2">
//                                         <Check className="w-4 h-4 text-green-600 mt-0.5 flex-shrink-0" />
//                                         <span>Supported formats: .xlsx, .xls, .csv, .json</span>
//                                     </li>
//                                     <li className="flex items-start gap-2">
//                                         <Check className="w-4 h-4 text-green-600 mt-0.5 flex-shrink-0" />
...
//                                     <p className="text-sm text-gray-500 mt-2">Previewing file...</p>
//                                 </div>
//                             ) : preview && (
//                                 <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 overflow-hidden">
//                                     <div className="p-5 border-b border-gray-200 dark:border-gray-700">
//                                         <h2 className="text-lg font-semibold text-gray-900 dark:text-white">File Preview</h2>
//                                     </div>
//                                     <div className="p-5">
...
//                                                 <span className="font-medium text-green-600">{preview.valid_rows}</span>
//                                             </div>
...
//                                             </div>
//                                             {preview.hasJsonDataColumn && (
//                                                 <div className="mt-2 p-2 bg-green-50 dark:bg-green-900/20 rounded">
//                                                     <p className="text-xs text-green-700 dark:text-green-300">
//                                                         ✓ Detected 'json_data' column format
//                                                     </p>
//                                                 </div>
//                                             )}
//                                         </div>
...
//                 uploadName={selectedUpload?.file_name}
//             />
//         </>
//     );
// }
        ...
        <>
            <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-100 dark:from-gray-900 dark:via-gray-900 dark:to-gray-800">
                <div className="mx-auto">
                    {/* Header */}
                    <div className="mb-8">
                        {/* <Link href="#" className="inline-flex items-center gap-2 text-gray-600 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 transition mb-4">
