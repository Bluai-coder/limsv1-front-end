...
export default function AdminTemplateModal({ isOpen, onClose, mode, template, onSuccess }) {
    ...
    const [formData, setFormData] = useState({
        ...
        show_footer: true,
        signatures: [
            { id: 'technologist', label: 'Medical Lab Technologist' },
            { id: 'pathologist', label: 'Pathologist' },
            { id: 'director', label: 'Medical Director' }
        ],
        is_default: false,
        is_active: true,
    ...
    useEffect(() => {
        if (mode === 'edit' && template) {
            setFormData({
                ...
                signatures: template.header_config?.signatures || [
                    { id: 'technologist', label: 'Medical Lab Technologist' },
                    { id: 'pathologist', label: 'Pathologist' },
                    { id: 'director', label: 'Medical Director' }
                ],
                        ...
                        <>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <input
                                        type="text"
                                        value={formData.header_config?.lab_name || ''}
                                        onChange={(e) => setFormData({
                                            ...formData,
                                            header_config: { ...formData.header_config, lab_name: e.target.value }
                                        })}
                                        className="w-full px-3.5 py-2.5 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white transition"
                ...
                <div className="fixed inset-0 z-[60] flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
                    <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl w-full max-w-6xl h-[90vh] flex flex-col overflow-hidden">
                        <div className="bg-gradient-to-r from-blue-600 to-indigo-600 px-6 py-4 flex justify-between items-center">
                            ...
                            <button onClick={() => setIsPreviewOpen(false)} className="text-white/80 hover:text-white transition p-1 rounded-lg hover:bg-white/10">
                                <X className="w-5 h-5" />
                            </button>
                        </div>
