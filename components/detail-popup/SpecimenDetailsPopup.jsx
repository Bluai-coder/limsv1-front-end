  ...
  return (
    <>
      ...
      <div
        ref={popupRef}
        onClick={handlePopupClick}
        className={`fixed right-0 top-0 h-full w-full mb-4 !m-0 sm:max-w-2xl lg:max-w-3xl bg-white dark:bg-gray-800 shadow-2xl z-50 transition-transform duration-300 ease-out ${
          isAnimating ? 'translate-x-0' : 'translate-x-full'
        }`}
      >
